...
export class JsongeneratorService {
  ...
  USER_URL:string    =  'http://localhost:9090/taskManager/userAction';
  PROJECT_URL:string =  'http://localhost:9090/taskManager/projectAction';
  TASK_URL:string    =  'http://localhost:9090/taskManager/taskAction';
  PARENT_URL:string    =  'http://localhost:9090/taskManager/parentAction';
